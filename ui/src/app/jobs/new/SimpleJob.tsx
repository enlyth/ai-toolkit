                    ...
                    <div>
                      <FormGroup label="Settings" className="">
                        ...
                        <Checkbox
                          ...
                          checked={dataset.preserve_exact_resolutions || false}
                          onChange={value =>
                            setJobConfig(value, `config.process[0].datasets[${i}].preserve_exact_resolutions`)
                          }
                          docKey="datasets.preserve_exact_resolutions"
                        />
                      </FormGroup>
                    </div>
                    <div>
                          ...
                          {[
                            ...
                            <div key={resGroup[0]} className="space-y-2">
                              {resGroup.map(res => (
                                <Checkbox
                                  key={res}
                                  disabled={dataset.preserve_exact_resolutions}
                                  label={res.toString()}
